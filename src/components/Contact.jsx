  ...
  return (
    <>
      ...
      <div className='flex flex-row justify-center items-center'>
        <div className="mx-48 ml-10 my-24">
          <h2 className="text-4xl ml-32 font-bold text-gray-900 mb-10">Contact Us</h2>
          <form action="#" method="POST">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6">
              <div>
                ...
                <div className="mt-1">
                  <input type="text" className="rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:outline-none" />
                </div>
              </div>
              <div>
            ...
            <button className="rounded-xl font-semibold border-0 px-14 py-3 mt-6 ml-36 mb-2 bg-callaction text-white active:bg-secondary duration-200 ease-in">
              Submit
            </button>
          </form>
        </div>
        <img src={contact} alt="Contact" className="h-96" />
      </div>
    </>
  );
};
