      ...
      <div className='bg-secondary'>
        <div>
          <div className='flex flex-col justify-center items-center'>
            <h2 className="font-semibold mt-24 text-white mb-2 text-4xl sm:text-5xl">About Us</h2>
            <hr className='text-white w-36 border-2 rounded-full' />
          </div>
          <p className="text-center text-white mx-4 xs:mx-16 sm:mx-36 mt-10 text-sm xs:text-lg sm:text-xl mb-10">
        ...
        <div className="w-50 h-50 mx-auto">
          <Carousel showArrows={true} showThumbs={false} >
            {/* first slide*/}
            <div className="flex flex-row justify-center items-center space-x-24 py-16 md:py-6">
              <div className="flex flex-col text-white bg-white/20 w-3/5 md:w-[500px] lg:w-2/5 h-80 md:h-96 p-10 border-2 rounded-2xl">
                <h1 className="font-poppins font-semibold text-xl xs:text-3xl md:text-4xl lg:text-5xl mb-4 md:mb-8 lg:mb-10">
                  Our Vision
                </h1>
                <p className="font-normal text-left text-xs xs:text-sm sm:text-[18px] leading-5 xs:leading-8">
